    ...
    public partial class Form21 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string sql = "updata Student set Id='"+textBox1.Text+"'where Id='"+str[0]+"and Name='"+str[1]+"'";
                    Dao dao=new Dao();
                    dao.Excute(sql);
                    str[0] = textBox1.Text;
                }
                ...
                {
                    string sql = "updata Student set Name='" + textBox2.Text + "'where Id='" + str[0] + "and Name='" + str[1] + "'";
                    Dao dao = new Dao();
                    dao.Excute(sql);
                    str[1] = textBox2.Text;
                }
                ...
                {
                    string sql = "updata Student set Class='" + textBox3.Text + "'where Id='" + str[0] + "and Name='" + str[1] + "'";
                    Dao dao = new Dao();
                    dao.Excute(sql);
                    str[2] = textBox3.Text;
                }
                ...
                {
                    string sql = "updata Student set Birthday='" + textBox4.Text + "'where Id='" + str[0] + "and Name='" + str[1] + "'";
                    Dao dao = new Dao();
                    dao.Excute(sql);
                    str[0] = textBox4.Text;
                }
                ...
                {
                    string sql = "updata Student set JG='" + textBox5.Text + "'where Id='" + str[0] + "and Name='" + str[1] + "'";
                    Dao dao = new Dao();
                    dao.Excute(sql);
                    str[4] = textBox5.Text;
                }
